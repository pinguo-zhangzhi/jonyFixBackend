...
export default class UploadFileManager {
	...
	uploadToQiniu(params) {
		...
		// 文件上传
		formUploader.putFile(params.uptoken, params.key, params.filePath, putExtra, function(respErr, respBody, respInfo) {
			if (respErr) {
				throw respErr;
			}
